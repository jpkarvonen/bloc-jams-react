...
*	A player bar with play/pause, previous track, next track, seek and volume options
*	Displays albums with cover and lists songs
* Has three pages (Landing, Library, Albums) and supports multiple albums. Client-side page transitions are handled with React Router
